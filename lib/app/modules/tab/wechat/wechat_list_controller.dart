...
class WeChatListController extends BaseCollectController {
  ...
  StreamController<List<Article>> listController = StreamController<
      List<Article>>();
  ...
  Future _request(int num) {
    return WanContainer().wanRepository.getWebChatList(num, _cid)
        .then((value) {
